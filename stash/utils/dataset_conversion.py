...
def convert_to_yolo(dataset_path: str, output_path: str) -> None:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Конвертация в YOLO формат датасета")

    parser.add_argument("-d", '--dataset', type=str, help='Путь до датасета формата COCO')
    parser.add_argument("-o", '--output', type=str, help='Путь для сохранения результатов')

    args = parser.parse_args()

    convert_to_yolo(args.dataset, args.output)
